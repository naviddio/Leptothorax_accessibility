...
for niteration in range(1): # Number of simulations to run
    for Rd in [0]: # The level of phase synchrony between the ants (i.e., Kurmamoto order parameter) 
        ...
        while k < stepCount:
            ...
            sector_populations_active.append(antDensityInactive) #Record the number of active ants in each sector at each time step
            sector_populations_inactive.append(antDensityActive) #Record the number of inactive ants in each sector at each time step
